...
public class Main {
    ...
    public Main(IServerFactory serverFactory, String[] args) {
        parseOptions(args);
    ...
    public Main(IServerFactory serverFactory, ServerSocketFactory ss, String[] args) {
        parseOptions(args);
        this.serverFactory = serverFactory;
    ...
    public Main(IServerFactory serverFactory, ThreadFactory threadFactory, String[] args) {
        parseOptions(args);
        this.serverFactory = serverFactory;
        this.loop = false;
        this.serverSocketFactory = new ServerSocketFactory();
    ...
    private Thread createServerSpawnerThread(Socket socket) throws IOException {
        return threadFactory.generate(new ServerSpawner( new SocketIO(socket), options.get("d"), serverFactory ));
    }
